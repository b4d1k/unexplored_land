...
//		.def("best_sound",					&CScriptGameObject::GetBestSound)
		...
		.def("get_current_outfit_camuflage",&CScriptGameObject::GetCurrentOutfitCamuflageCoeff)
		// end
		// skif : (ф-ции для скриптов)
		.def("get_inv_name",&CScriptGameObject::GetInvName)
		.def("get_inv_descr",&CScriptGameObject::GetInvDescr)
		.def("get_inv_name_by_section",(LPCSTR (CScriptGameObject::*)(LPCSTR))(&CScriptGameObject::GetInvNameBySection))
		.def("get_inv_descr_by_section",(LPCSTR (CScriptGameObject::*)(LPCSTR))(&CScriptGameObject::GetInvDescrBySection))
		// end
