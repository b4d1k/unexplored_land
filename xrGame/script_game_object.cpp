...
BIND_FUNCTION10	(&object(),	CScriptGameObject::GetSleep,			CEntityAlive,	conditions().GetSleep,			float,							-1);
//end
...
BIND_FUNCTION01	(&object(),	CScriptGameObject::ChangeSleep,		CEntityAlive,	conditions().ChangeSleep,			float,							float);
//end
