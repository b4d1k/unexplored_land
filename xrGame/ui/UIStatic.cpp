...
#include "UIBtnHint.h"
#include "UICursor.h"
#include "ui/UIInventoryUtilities.h" // skif : (методы GUI-элементов)
...
void CUIStatic::SetItemIconEq(LPCSTR section, bool stretch)
{
	SetShader(InventoryUtilities::GetEquipmentIconsShader());
	Frect texture_rect;
