...
void CUITalkWnd::AddRelocateItemTalkMessage	(LPCSTR caption, LPCSTR text, LPCSTR texture_name, LPCSTR section, LPCSTR templ_name)
{
	UITalkDialogWnd->AddRelocateItemIconedAnswer(caption, text, texture_name, section, templ_name);
}
// end
