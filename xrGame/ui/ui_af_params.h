...
protected:
	...
	UIArtefactParamItem*	m_wound_imm;
	UIArtefactParamItem*	m_fwound_imm;
	UIArtefactParamItem*	m_expl_imm;
	UIArtefactParamItem*	m_strk_imm;
	UIArtefactParamItem*	m_psy_heal_restore;
	UIArtefactParamItem*	m_walk_accel;
	UIArtefactParamItem*	m_jump_speed;
	//end
