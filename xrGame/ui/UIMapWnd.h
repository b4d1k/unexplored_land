...
public:
	...
	virtual void				Update					();
			...
			void				ShowHintIconedSpot		(LPCSTR icon, LPCSTR caption, LPCSTR text, LPCSTR time, CUIWindow* owner);
			// end
	...
	void						UpdatePdaMaps(); // skif : (отображение локаций в ПДА по инфопоршню)
