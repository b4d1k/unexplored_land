...
//	CUIStatic*			m_back_over_arrow;
	CUIStatic*			m_static_armor; // skif : (стамина брони на худе)
...
//	CUIStatic*			m_resist_back[it_max];
	...
	CUIProgressBar*		m_ui_armor_bar; // skif : (стамина брони на худе)
	CUIProgressBar*		m_ui_stamina_bar;
	// skif : (батарейка для фонарика)
	CUIProgressBar*		m_torch_batarey_bar;
	CUIStatic*			m_torch_batarey_state;
	// end
