...
protected:
	...
	CUIStatic				m_stAmmoType3; // skif : (отображение всех используемых патрон для оружия)
	CUIStatic				m_stAmmoType4; // skif : (отображение всех используемых патрон для оружия)
