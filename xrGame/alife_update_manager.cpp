...
void CALifeUpdateManager::new_game			(LPCSTR save_name)
{
	...
	g_pGamePersistent->LoadTitle		(true, "st_creating_new_game");
...
{
	// skif : (вывод стадий загрузки сохранения)
	g_pGamePersistent->LoadTitle		(true, "st_loading_alife_simulator");
	// end
...
#endif
	// skif : (вывод стадий загрузки сохранения)
	//g_pGamePersistent->LoadTitle		(true, "st_server_connecting");
