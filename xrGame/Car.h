...
class CCanister : public CInventoryItemObject {
private:
	typedef CInventoryItemObject inherited;
public:
	CCanister(void);
	virtual ~CCanister(void);
	virtual void Load(LPCSTR section);
	virtual void UpdateCL();
	...
	void  ChangeFuel(float val);
	void  Update();

};

class CCarToolkit : public CInventoryItemObject {
private:
	typedef CInventoryItemObject inherited;
public:
	CCarToolkit(void);
	virtual ~CCarToolkit(void);
	virtual void Load(LPCSTR section);
	virtual void UpdateCL();
	virtual void save(NET_Packet &output_packet);
	virtual void load(IReader &input_packet);
