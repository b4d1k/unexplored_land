...
void CUIZoneMap::Init()
{
	...
	m_center.SetWndPos				(Fvector2().set(m_clipFrame.GetWidth()/2.0f, m_clipFrame.GetHeight()/2.0f)); // skif : квадратная миникарта
	
	m_Counter_text.SetText( "" );
	visible = true;
	// skif : квадратная миникарта (закомментировано)
	/*
