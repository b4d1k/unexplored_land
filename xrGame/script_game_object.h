...
public:
	...
	//передача порции информации InventoryOwner
			...
			void				GiveGameNewsRelocateItem(LPCSTR caption, LPCSTR text, LPCSTR texture_name, LPCSTR section, int show_time);
			void				GiveTalkMessageRelocateItem(LPCSTR caption, LPCSTR text, LPCSTR texture_name, LPCSTR section, LPCSTR templ_name);
			// end
