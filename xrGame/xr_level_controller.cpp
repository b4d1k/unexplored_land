...
_action  actions[]		= {
	...
	// skif : (транспорт)
	{ "switch_engine",		kENGINE					,_both},
	// end
	// skif : (хоткей для вкл\выкл худа)
	{ "show_hud",			kSHOW_HUD				,_both},
	// end
	// skif : (вид от 1, 2, 3 лица)
	{ "set_cam1",			kSET_CAM1				,_both},
	{ "set_cam2",			kSET_CAM2				,_both},
	{ "set_cam3",			kSET_CAM3				,_both},
	// end
	{ "quit",				kQUIT					,_both},	
