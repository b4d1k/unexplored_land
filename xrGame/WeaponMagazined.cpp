...
void CWeaponMagazined::Load	(LPCSTR section)
{
	...
	// skif : (в патроннике остается патрон)
	m_shotInChamber = READ_IF_EXISTS(pSettings, r_bool, section, "shoot_in_chamber", false);
	// end
...
void CWeaponMagazined::FireEnd() 
{
	...
	//skif : (блокировка автоперезарядки)
...
void CWeaponMagazined::switch2_Reload()
{
	...
	bool bEmptyEnable = iAmmoElapsed > 0 && m_shotInChamber; /*isHUDAnimationExist("anm_reload_empty")*/
