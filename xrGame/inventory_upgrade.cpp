...
void Upgrade::construct( const shared_str& upgrade_id, Group& parental_group, Manager& manager_r )
{
	...
	// skif
	LPCSTR precondition_functor_str	= READ_IF_EXISTS( pSettings, r_string, id(), "precondition_functor", "inventory_upgrades.precondition_functor_a" );
	m_preconditions.parameter		= READ_IF_EXISTS( pSettings, r_string, id(), "precondition_parameter", "a & b" );
	// end
	...
	// effect_functor
	// skif
	LPCSTR effect_functor_str	= READ_IF_EXISTS( pSettings, r_string, id(), "effect_functor", "inventory_upgrades.effect_functor_a" );
	m_effects.parameter			= READ_IF_EXISTS( pSettings, r_string, id(), "effect_parameter", "something_here" );
	// end
	...
	// skif
	LPCSTR prereq_functor_str	= READ_IF_EXISTS( pSettings, r_string, id(), "prereq_functor", "inventory_upgrades.prereq_functor_a" );
	m_prerequisites.parameter	= READ_IF_EXISTS( pSettings, r_string, id(), "prereq_params", "" );
	// end
