...
enum EBoostParams{
	...
	eBoostBurnProtection, //skif : (термозащита у бустеров)
	eBoostElectroProtection, //skif : (электрозащита у бустеров)
	eBoostJumpSpeed, //skif : (высота прыжков у бустеров)
	eBoostPsyHpRestore, //skif : (восстановление пси-здоровья у бустеров)
	eBoostBurnImmunity,
	eBoostShockImmunity,
...
static const LPCSTR ef_boosters_section_names[] =
{
	...
	"boost_burn_protection", //skif : (термозащита у бустеров)
	"boost_shock_protection", //skif : (электрозащита у бустеров)
	"boost_jump_speed", //skif : (высота прыжков у бустеров)
	"boost_psy_health_restore", //skif : (восстановление пси-здоровья у бустеров)
	"boost_burn_immunity",
...
protected:
	...
	float 				m_fBoostBurnProtection; //skif : (термозащита у бустеров)
	float 				m_fBoostElectroProtection; //skif : (электрозащита у бустеров)
