...
//		.def("set_sight",					(void (CScriptGameObject::*)(const MemorySpace::CMemoryInfo *memory_object, bool	torso_look))(&CScriptGameObject::set_sight))
		...
		.def("give_relocate_item_message",	(void (CScriptGameObject::*)(LPCSTR,LPCSTR,LPCSTR,LPCSTR,int))(&CScriptGameObject::GiveGameNewsRelocateItem))
		.def("give_relocate_item_message_talk",	(void (CScriptGameObject::*)(LPCSTR,LPCSTR,LPCSTR,LPCSTR,LPCSTR))(&CScriptGameObject::GiveTalkMessageRelocateItem))
		//end
