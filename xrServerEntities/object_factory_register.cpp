...
//	add<CSE_SpawnGroup>											(CLSID_AI_SPAWN_GROUP			,"spawn_group");
	...
	ADD(CTorchBatarey			,CSE_ALifeItem					,CLSID_IITEM_TORCH_BATAREY		,"obj_torch_batarey");
	// end
	// skif
	ADD(CCanister				,CSE_ALifeItem					,CLSID_IITEM_CANISTER			,"obj_canister");
	ADD(CCarToolkit				,CSE_ALifeItem					,CLSID_IITEM_CAR_TOOLKIT		,"obj_car_toolkit");
	// end
