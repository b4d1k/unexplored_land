...
#define CLSID_IITEM_TORCH_BATAREY	MK_CLSID('D','_','T','R','C','_','B','T')
// end
// skif
#define CLSID_IITEM_CANISTER		MK_CLSID('D','_','C','A','N','S','T','R')
#define CLSID_IITEM_CAR_TOOLKIT		MK_CLSID('D','_','C','R','T','O','L','K')
// end
